...
export const translations = {
  ru: {
    nav: { concept: "Концепция", process: "Процесс", profile: "Профиль", application: "Применение", blockchain: "TZNK & Блокчейн", contact: "Связь" },
    ...
    phil: { 
      ...
      f3: "Спектр антоцианов", f3d: "Полное сохранение фиолетового пигмента и полифенольного профиля без окислительного следа."
    },
    terroir: {
    ...
    process: {
      ...
      photoCaption: "Финальный хрустящий фиолетовый боб в идеально чистой оболочке"
    },
    comp: {
  ...
  en: {
    nav: { concept: "Concept", process: "Process", profile: "Profile", application: "Application", blockchain: "TZNK & Blockchain", contact: "Contact" },
    ...
    phil: { 
      ...
      f3: "Anthocyanin Spectrum", f3d: "Full preservation of purple pigment and polyphenol profile with no oxidative footprint."
    },
    terroir: {
    ...
    process: {
      ...
      photoCaption: "Final crunchy purple bean in a perfectly clean shell"
    },
    comp: {
  ...
  es: {
    nav: { concept: "Concepto", process: "Proceso", profile: "Perfil", application: "Aplicación", blockchain: "TZNK & Blockchain", contact: "Contacto" },
    ...
    phil: { 
      ...
      f3: "Espectro de antocianinas", f3d: "Preservación total del pigmento púrpura y del perfil polifenólico sin huella oxidativa."
    },
    terroir: {
    ...
    process: {
      ...
      photoCaption: "Grano púrpura final, crujiente y con una cáscara perfectamente limpia"
    },
    comp: {
